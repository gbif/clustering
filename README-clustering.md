...
The following instructions are outdated from the migration from Cloudera, but left here for reference.
Please adapt them to the K8s environment as needed.
